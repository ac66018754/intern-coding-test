...
function App() {
  ...
  if(mode=="dark"){
    document.getElementById("html").className="dark-mode"
  }
  else{
    document.getElementById("html").className="light-mode"
  }
  ...
  return (
    <div className="app">
      <div className="level">
        ...
        <button className="app__dark-mode-btn icon level-right" onClick={() => {if(mode=="dark")changeMode("light");else changeMode("dark")}}>
          <FontAwesomeIcon icon={mode=="light"?faMoon:faSun} color={mode=="light"?"":"#FFA500"}/>
        </button> 
